...
class Account extends DataClass implements Insertable<Account> {
  ...
  Account copyWith({String? id, String? name, AccountType? type}) => Account(
    id: id ?? this.id,
    name: name ?? this.name,
    type: type ?? this.type,
  );
...
class Transaction extends DataClass implements Insertable<Transaction> {
  ...
  Transaction copyWith({String? id, DateTime? date, String? description}) =>
      Transaction(
        id: id ?? this.id,
        date: date ?? this.date,
...
class $JournalEntriesTable extends JournalEntries
  ...
  late final GeneratedColumnWithTypeConverter<EntryType, String> type =
      GeneratedColumn<String>(
        ...
        type: DriftSqlType.string,
        requiredDuringInsert: true,
      ).withConverter<EntryType>($JournalEntriesTable.$convertertype);
  ...
  static JsonTypeConverter2<EntryType, String, String> $convertertype =
      const EnumNameConverter(EntryType.values);
}
...
class JournalEntry extends DataClass implements Insertable<JournalEntry> {
  ...
  @override
  int get hashCode => Object.hash(id, transactionId, accountId, type, amount);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
